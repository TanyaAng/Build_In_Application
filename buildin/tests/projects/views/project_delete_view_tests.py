...
class ProjectDeleteViewTests(TestCase):
    ...
    @mute_signals(post_save)
    def test_delete_project__when_user_try_to_access_project_where_not_owner__expect_to_be_forbidden(self):
        ...
        response = self.client.get(reverse('project delete', kwargs={'build_slug': second_project.slug}))
